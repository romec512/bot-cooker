...
namespace Bot_Application1.Dialogs
{
    ...
    public class EchoDialog : IDialog<object>
    {
        ...
        public async Task MessageReceivedAsync(IDialogContext context, IAwaitable<IMessageActivity> argument)
        {
            ...
            Regex reciept = new Regex(@"<td valign=""top"" style=""padding: 0px 0px 0px 6px;"">[a-zA-Zа-яА-Яё\s\d\n\*\»\«\:\;\-\.\,\!\?\)\(""]+</td>");
            Regex NameRecieptReg = new Regex(@"<a href=""http://www.povarenok.ru/recipes/show/[0-9]+/"">[a-zA-Zа-яА-Яё\s\v\d\n\*\»\«\:\;\-\.\,\!\?\)\(""]+</a>");
            Match art;
            ...
            NameReciept = Regex.Match(NameReciept, @">[a-zA-Zа-яА-Яё\s\d\n\v\*\»\«\:\;\-\.\,\!\?\)\(""]+<").ToString();
            NameReciept = Regex.Match(NameReciept, @"[a-zA-Zа-яА-Яё\s\d\n\v\*\»\«\:\;\-\.\,\!\?\)\(""]+").ToString();
                ...
                //ничего умнее не придумал, увы :/
            {
                ...
                point = Regex.Match(point, @">[a-zA-Zа-яА-Яё\s\d\n\v\*\»\«\:\;\-\.\,\!\?\)\(""]+<").ToString();
                point = Regex.Match(point, @"[a-zA-Zа-яА-Яё\s\d\n\v\*\»\«\:\;\-\.\,\!\?\)\(""]+").ToString();
